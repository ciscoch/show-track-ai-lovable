...
export const mockAnimals: Animal[] = [
  { id: "1", name: "Blue Ribbon", species: "cattle", breed: "Angus", breederName: "Farm A", gender: "male", birthdate: "2020-05-15", weight: 1200, image: "/placeholder.svg", description: "Champion Angus bull", showAnimal: true, purpose: "show", penNumber: "A1" },
  { id: "2", name: "Champion", species: "goat", breed: "Boer", breederName: "Farm B", gender: "female", birthdate: "2021-03-20", weight: 150, image: "/placeholder.svg", description: "Prize-winning Boer goat", showAnimal: true, purpose: "breeding", penNumber: "B2" },
  { id: "3", name: "Star", species: "sheep", breed: "Dorset", breederName: "Farm C", gender: "female", birthdate: "2022-01-10", weight: 180, image: "/placeholder.svg", description: "Excellent Dorset ewe", showAnimal: true, purpose: "market", penNumber: "C3" },
];
